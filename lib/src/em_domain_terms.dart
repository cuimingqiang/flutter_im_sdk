...
class EMMessage {
  ...
  EMMessage.createImageSendMessage(
      String filePath, bool sendOriginalImage, String userName,{int width,int height})
      : this(
            direction: Direction.SEND,
            type: EMMessageType.IMAGE,
            body: EMImageMessageBody(File(filePath), sendOriginalImage,width: width,height: height),
            to: userName);
